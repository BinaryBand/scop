...
Information about the current status of this document and how to provide feedback may be obtained at <https://github.com/BinaryBand/scop.git>.

---

## Copyright Notice

Copyright (c) 2026 Shane D. (editor). All rights reserved.
...
- [4. Foundation Standards](#4-foundation-standards)
  - [4.1. POSIX.1 and GNU](#41-posix1-and-gnu)
  - [4.2. RFC 5424 Fields](#42-rfc-5424-fields)
...
- [10. Auto-Translation Rules](#10-auto-translation-rules)
  - [10.1. Consumer State Model (Informative)](#101-consumer-state-model-informative)
...
| ----- | ------- | ---------------------------------------- |
| PRI   | `pri`   | Severity level (0–7), encoded as integer |
