...
- [RFC 9920: RFC Editor Model (Version 3)](https://www.rfc-editor.org/info/rfc9920/)

## Abstract

RFC documents contain a number of fixed elements such as the title page header, standard boilerplates, and copyright/IPR statements. This document describes them and introduces some updates to reflect current usage and requirements of RFC publication. In particular, this updated structure is intended to communicate clearly the source of RFC creation and review. This document obsoletes [RFC 5741](https://www.rfc-editor.org/info/rfc5741/), moving detailed content to an IAB web page and preparing for more flexible output formats.

## Status of This Memo

This document is not an Internet Standards Track specification; it is published for informational purposes.

This document is a product of the Internet Architecture Board (IAB) and represents information that the IAB has deemed valuable to provide for permanent record. It represents the consensus of the Internet Architecture Board (IAB). Documents approved for publication by the IAB are not a candidate for any level of Internet Standard; see [Section 2 of RFC 5741](https://www.rfc-editor.org/info/rfc5741/#2-rfc-streams-and-internet-standards).

Information about the current status of this document, any errata, and how to provide feedback on it may be obtained at [<http://www.rfc-editor.org/info/rfc7841>](https://www.rfc-editor.org/info/rfc7841).

## Copyright Notice

Copyright (c) 2016 IETF Trust and the persons identified as the document authors. All rights reserved.

This document is subject to [BCP 78](https://www.rfc-editor.org/bcp/bcp78) and the IETF Trust's Legal Provisions Relating to IETF Documents (<http://trustee.ietf.org/license-info>) in effect on the date of publication of this document. Please review these documents carefully, as they describe your rights and restrictions with respect to this document.

## Table of Contents

- [1](#1-introduction). Introduction
- [2](#2-rfc-streams-and-internet-standards). RFC Streams and Internet Standards
- [3](#3-rfc-structural-elements). RFC Structural Elements
  - [3.1](#31-the-title-page-header). The Title Page Header
  - [3.2](#32-the-status-of-this-memo). The Status of This Memo
  - [3.3](#33-paragraph-1). Paragraph 1
  - [3.4](#34-paragraph-2). Paragraph 2
  - [3.5](#35-paragraph-3). Paragraph 3
  - [3.6](#36-noteworthy). Noteworthy
- [4](#4-additional-notes). Additional Notes
- [5](#5-other-structural-information-in-rfcs). Other Structural Information in RFCs
- [6](#6-security-considerations). Security Considerations
- [7](#7-rfc-editor-considerations). RFC Editor Considerations
- [8](#8-references). References
  - [8.1](#81-normative-references). Normative References
  - [8.2](#82-informative-references). Informative References
- [Appendix A](#appendix-a-initial-formatting-details). Initial Formatting Details
  - [A.1](#a1-rfc-title-page-header). RFC Title Page Header
  - [A.2](#a2-constructing-a-status-of-this-memo-section). Constructing a "Status of This Memo" Section
    - [A.2.1](#a21-first-paragraph). First Paragraph
    - [A.2.2](#a22-second-paragraph). Second Paragraph
    - [A.2.3](#a23-third-paragraph). Third Paragraph
...
Refer to [[RFC2026](https://www.rfc-editor.org/info/rfc2026/)], [[RFC5742](https://www.rfc-editor.org/info/rfc5742/)], [[RFC4844](https://www.rfc-editor.org/info/rfc4844/)], [[RFC6410](https://www.rfc-editor.org/info/rfc6410/)], and [[RFC7127](https://www.rfc-editor.org/info/rfc7127/)] and their successors for current details of the IETF process and RFC streams.
...
<document source> This describes the area where the work originates. Historically, all RFCs were labeled "Network Working Group". Network Working Group refers to the original version of today's IETF when people from the original set of ARPANET sites and whomever else was interested -- the meetings were open -- got together to discuss, design, and document proposed protocols [[RFC3](https://www.rfc-editor.org/info/rfc3/)]. Here, we obsolete the term "Network Working Group" in order to indicate the originating stream.

The <document source> is the name of the RFC stream, as defined in [[RFC4844](https://www.rfc-editor.org/info/rfc4844/)] and its successors. At the time of this publication, the streams, and therefore the possible entries are:
...
<subseries ID> <subseries number> Some document categories are also labeled as a subseries of RFCs. These elements appear as appropriate for such categories, indicating the subseries and the documents number within that series. Currently, there are subseries for BCPs [[RFC2026](https://www.rfc-editor.org/info/rfc2026/)] and STDs [[RFC1311](https://www.rfc-editor.org/info/rfc1311/)]. These subseries numbers may appear in several RFCs. For example, when a new RFC obsoletes or updates an old one, the same subseries number is used. Also, several RFCs may be assigned the same subseries number: a single STD, for example, may be composed of several

> RFCs, each of which will bear the same STD number. This element is unchanged.

[<RFC relation>:<RFC number[s]>] Some relations between RFCs in the series are explicitly noted in the RFC header. For example, a new RFC may update one or more earlier RFCs. Currently two relationships are defined: "Updates" and "Obsoletes" [[RFC7322](https://www.rfc-editor.org/info/rfc7322/)]. Variants like "Obsoleted by" are also used (e.g, in [[RFC5143](https://www.rfc-editor.org/info/rfc5143/)]). Other types of relationships may be defined by the RFC Editor and may appear in future RFCs.

Category: <category> This indicates the initial RFC document category of the publication. These are defined in [[RFC2026](https://www.rfc-editor.org/info/rfc2026/)]. Currently, this is always one of: Standards Track, Best Current Practice, Experimental, Informational, or Historic. This element is unchanged.
...
RFCs contain other structural informational elements. The RFC Editor is responsible for the positioning and layout of these structural elements. Note also that new elements may be introduced or obsoleted using a process consistent with [[RFC4844](https://www.rfc-editor.org/info/rfc4844/)]. These additions may or may not require documentation in an RFC.

Currently, the following structural information is available in RFCs:

Copyright Notice: A copyright notice with a reference to [BCP 78](https://www.rfc-editor.org/bcp/bcp78) [BCP78] and an Intellectual Property statement referring to [BCP 78](https://www.rfc-editor.org/bcp/bcp78) and [BCP 79](https://www.rfc-editor.org/bcp/bcp79) [BCP79]. The content of these statements are defined by those BCPs.
...
The RFC Editor is responsible for maintaining the consistency of the RFC series. To that end, the RFC Editor maintains an "RFC Style Guide" [[RFC7322](https://www.rfc-editor.org/info/rfc7322/)]. In this memo, we mention a few explicit structural elements that the RFC Editor needs to maintain. The conventions for the content and use of all current and future elements are documented in the style guide.
...
- [RFC2026] Bradner, S., "The Internet Standards Process -- Revision 3", [BCP 9](https://www.rfc-editor.org/bcp/bcp9), [RFC 2026](https://www.rfc-editor.org/info/rfc2026/), DOI 10.17487/RFC2026, October 1996, <[<http://www.rfc-editor.org/info/rfc2026>](<https://www.rfc-editor.org/info/rfc2026>)>.

- [RFC5742] Alvestrand, H. and R. Housley, "IESG Procedures for Handling of Independent and IRTF Stream Submissions", [BCP 92](https://www.rfc-editor.org/bcp/bcp92), [RFC 5742](https://www.rfc-editor.org/info/rfc5742/), DOI 10.17487/RFC5742, December 2009, <[<http://www.rfc-editor.org/info/rfc5742>](<https://www.rfc-editor.org/info/rfc5742>)>.
...
- [RFC3] Crocker, S., "Documentation conventions", [RFC 3](https://www.rfc-editor.org/info/rfc3/), DOI 10.17487/RFC0003, April 1969, <[<http://www.rfc-editor.org/info/rfc3>](<https://www.rfc-editor.org/info/rfc3>)>.
- [RFC1311] Postel, J., "Introduction to the STD Notes", [RFC 1311](https://www.rfc-editor.org/info/rfc1311/), DOI 10.17487/RFC1311, March 1992, <[<http://www.rfc-editor.org/info/rfc1311>](<https://www.rfc-editor.org/info/rfc1311>)>.
- [RFC4844] Daigle, L., Ed. and Internet Architecture Board, "The RFC Series and RFC Editor", [RFC 4844](https://www.rfc-editor.org/info/rfc4844/), DOI 10.17487/RFC4844, July 2007, <[<http://www.rfc-editor.org/info/rfc4844>](<https://www.rfc-editor.org/info/rfc4844>)>.
- [RFC5143] Malis, A., Brayley, J., Shirron, J., Martini, L., and S. Vogelsang, "Synchronous Optical Network/Synchronous Digital Hierarchy (SONET/SDH) Circuit Emulation Service over MPLS (CEM) Encapsulation", [RFC 5143](https://www.rfc-editor.org/info/rfc5143/), DOI 10.17487/RFC5143, February 2008, <[<http://www.rfc-editor.org/info/rfc5143>](<https://www.rfc-editor.org/info/rfc5143>)>.
- [RFC5741] Daigle, L., Ed., Kolkman, O., Ed., and IAB, "RFC Streams, Headers, and Boilerplates", [RFC 5741](https://www.rfc-editor.org/info/rfc5741/), DOI 10.17487/RFC5741, December 2009, <[<http://www.rfc-editor.org/info/rfc5741>](<https://www.rfc-editor.org/info/rfc5741>)>.
- [RFC6410] Housley, R., Crocker, D., and E. Burger, "Reducing the Standards Track to Two Maturity Levels", [BCP 9](https://www.rfc-editor.org/bcp/bcp9), [RFC 6410](https://www.rfc-editor.org/info/rfc6410/), DOI 10.17487/RFC6410, October 2011, <[<http://www.rfc-editor.org/info/rfc6410>](<https://www.rfc-editor.org/info/rfc6410>)>.
- [RFC7127] Kolkman, O., Bradner, S., and S. Turner, "Characterization of Proposed Standards", [BCP 9](https://www.rfc-editor.org/bcp/bcp9), [RFC 7127](https://www.rfc-editor.org/info/rfc7127/), DOI 10.17487/RFC7127, January 2014, <[<http://www.rfc-editor.org/info/rfc7127>](<https://www.rfc-editor.org/info/rfc7127>)>.
- [RFC7322] Flanagan, H. and S. Ginoza, "RFC Style Guide", [RFC 7322](https://www.rfc-editor.org/info/rfc7322/), DOI 10.17487/RFC7322, September 2014, <[<http://www.rfc-editor.org/info/rfc7322>](<https://www.rfc-editor.org/info/rfc7322>)>.
- [ERRATA] Hagens, A., Ginoza, S., and R. Braden, "RFC Editor Proposal for Handling RFC Errata", Work in Progress, [draft-rfc-editor-errata-process-02](https://www.rfc-editor.org/rfc/draft-rfc-editor-errata-process-02), May 2008.
- [BCP78] Bradner, S., Ed. and J. Contreras, Ed., "Rights Contributors Provide to the IETF Trust", [BCP 78](https://www.rfc-editor.org/bcp/bcp78), [RFC 5378](https://www.rfc-editor.org/info/rfc5378/), November 2008, <[<http://www.rfc-editor.org/info/bcp78>](<https://www.rfc-editor.org/info/bcp78>)>.
- [BCP79] Bradner, S., Ed., "Intellectual Property Rights in IETF Technology", [BCP 79](https://www.rfc-editor.org/bcp/bcp79), [RFC 3979](https://www.rfc-editor.org/info/rfc3979/), DOI 10.17487/RFC3979, March 2005.
- Narten, T., "Clarification of the Third Party Disclosure Procedure in [RFC 3979](https://www.rfc-editor.org/info/rfc3979/)", [BCP 79](https://www.rfc-editor.org/bcp/bcp79), [RFC 4879](https://www.rfc-editor.org/info/rfc4879/), DOI 10.17487/RFC4879, April 2007.
- <[<http://www.rfc-editor.org/info/bcp79>](<https://www.rfc-editor.org/info/bcp79>)>
...
For example, the header for [RFC 6410](https://www.rfc-editor.org/info/rfc6410/) appears as follows:

---

Internet Engineering Task Force (IETF) R. Housley Request for Comments: 6410 Vigil Security BCP: 9 D. Crocker Updates: [2026](https://www.rfc-editor.org/info/rfc2026/) Brandenburg InternetWorking Category: Best Current Practice E. Burger ISSN: 2070-1721 Georgetown University October 2011

---

### A.2. Constructing a "Status of This Memo" Section

The following sections describe mandated text for use in specific parts of the "Status of This Memo" portion of an RFC. For convenience, the RFC Editor maintains example expansions of all permutations of the paragraphs described in this document (at the time of publication, at [<http://www.rfc-editor.org/materials/status->](https://www.rfc-editor.org/materials/status-memos.txt) [memos.txt](https://www.rfc-editor.org/materials/status-memos.txt)). When in conflict, the following sections are authoritative.

### A.2.1. First Paragraph

The following are the approved texts for use in the first paragraph of the "Status of This Memo" portion of an RFC. See [Section 3.3 of<br> RFC 7841](https://www.rfc-editor.org/info/rfc7841/#33-paragraph-1).
...
See [Section 3.4 of RFC 7841](https://www.rfc-editor.org/info/rfc7841/#34-paragraph-2).
...
For non-IETF stream documents, a reference to [Section 2](#2-rfc-streams-and-internet-standards) of this RFC is added with the following sentence: "Documents approved for publication by the [stream approver -- currently, one of: "IAB", "IRSG", or "RFC Editor"] are not a candidate for any level of Internet Standard; see [Section 2 of RFC 7841](https://www.rfc-editor.org/info/rfc7841/#2-rfc-streams-and-internet-standards)."

For IETF stream documents, a similar reference is added: "Further information on (BCPs or Internet Standards) is available in [Section 2<br> of RFC 7841](https://www.rfc-editor.org/info/rfc7841/#2-rfc-streams-and-internet-standards)." for BCP and Standard Track documents; "Not all documents approved by the IESG are a candidate for any level of Internet Standards; see [Section 2 of RFC 7841](https://www.rfc-editor.org/info/rfc7841/#2-rfc-streams-and-internet-standards)." for all other categories.

### A.2.3. Third Paragraph

See [Section 3.5 of RFC 7841](https://www.rfc-editor.org/info/rfc7841/#35-paragraph-3).
